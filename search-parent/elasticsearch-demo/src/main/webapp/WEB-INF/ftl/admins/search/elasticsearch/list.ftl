...
<head>
    ...
    <script type="text/javascript"  charset="UTF-8">
        var searchUrl = "${contextPath}/admins/search/elasticsearch/list/data";
        var updateUrl = "${contextPath}/admins/search/elasticsearch/update";
        var insertUrl = "${contextPath}/admins/search/elasticsearch/save";
        var deleteUrl = "${contextPath}/admins/search/elasticsearch/delete";
        $(function() {
            $('#dataList').datagrid({
                title:'列表',
